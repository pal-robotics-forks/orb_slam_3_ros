...
void System::SaveTrajectoryTUM(const string &filename)
{
  ...
  // Frame pose is stored relative to its reference keyframe (which is optimized by BA and
  // pose graph).
...
void System::SaveDebugData(const int &initIdx)
{
  ...
  SaveTrajectoryEuRoC("init_FrameTrajectoy_" + to_string(mpLocalMapper->mInitSect) + "_" +
...
/*void System::SaveAtlas(int type){
    cout << endl << "Enter the name of the file if you want to save the current Atlas
session. To exit press ENTER: ";
    string saveFileName;
